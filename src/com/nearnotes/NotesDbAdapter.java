...
public class NotesDbAdapter {
     ...
     */
    public long createNote(String title, String body, double lat, double lng, String location) {
        ...
        try {
        	...
        	if (exception.toString().contains(locationNull)) {
        		Toast.makeText(mCtx, "Location cannot be empty", Toast.LENGTH_LONG).show();
        	}
     ...
     */
    public Cursor fetchAllNotes(Context context, double longitude, double latitude) {
    	...
    	String fudge = String.valueOf(Math.pow(Math.cos(Math.toRadians(latitude)),2));
    	return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_TITLE, KEY_BODY, KEY_LAT, KEY_LNG, KEY_LOCATION}, null, null, null, null, 
        		"(" + mlatitude + " - latitude) * (" + mlatitude + " - latitude) + (" + mlongitude + " - longitude) * (" + mlongitude + " - longitude) * " + fudge);
    ...
    public Cursor fetchNote(long rowId) throws SQLException {
        ...
        Cursor mCursor =
            ...
            mDb.query(true, DATABASE_TABLE, new String[] {KEY_ROWID,
                    KEY_TITLE, KEY_BODY, KEY_LAT, KEY_LNG, KEY_LOCATION}, KEY_ROWID + "=" + rowId, null,
                    null, null, null, null);
        if (mCursor != null) {
            mCursor.moveToFirst();
        }
    ...
    public boolean updateNote(long rowId, String title, String body, double lat, double lng, String location) {
    ...
    public boolean updateSetting(long rowId) {
    	 Cursor mCursor =   mDb.query(true, DATABASE_TABLE_SETTINGS, new String[] {KEY_ROWID,
    	                    KEY_SETTINGS_ONTOP}, null, null,
    	                    null, null, null, null);
    	 if (mCursor != null) {
             mCursor.moveToFirst();
             ...
             return mDb.update(DATABASE_TABLE_SETTINGS, args, KEY_ROWID + "=" + settingRowId, null) > 0;
         } else return false;
    ...
    public void removeSetting() {
   	 	...
   	 	if (mCursor != null) {
   	 		...
   	 		long result = mDb.update(DATABASE_TABLE_SETTINGS, args, KEY_ROWID + "=" + settingRowId, null);
   	 	} 
